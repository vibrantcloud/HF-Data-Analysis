...
columns = ['First Name', 'Last Name', 'Location Ledger Code', 'Job', 'Number',
       'Normal Weekly Hours', 'Contract Type', 'Date Joined', 'Gender']
...
st = pd.read_sql("SELECT Shop AS Store, Area, Location, Division from StructureTab",engine)
